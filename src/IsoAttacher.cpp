...
void IsoAttacher::AttachLegacy(std::string path, std::vector<std::string> isos, uint16_t build)
{
...
void IsoAttacher::AttachCerbios(std::string path, std::vector<std::string> isos, bool isCci)
{
	// Allocate some mem to use
